# Color Scheme Five — Dark Portal Theme
...
Anchor colors from the team's existing direction, extended with 
semantic tokens for charts, status indicators, and data tables.
